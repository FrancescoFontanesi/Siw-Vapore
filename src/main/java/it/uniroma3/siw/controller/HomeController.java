...
public class HomeController {
    ...
    public String index(Model model) {
         ...
         model.addAttribute("randomGames", randomGames);
			 ...
			 * System.out.println(userDetails.toString()); String email =
			 ...
			 * 
			 * User user = credentials.getUser(); System.out.println(user.toString()); }
			 * else { System.out.println("Principal is not an instance of UserDetails"); } }
			 * else { model.addAttribute("userPrincipal", null);
	...
	public String getCart(Model model,Authentication auth) {
    	...
    	model.addAttribute("customer", credentialsRepository.findByEmail(auth.getName()).get().getUser());
		return "cart.html";
