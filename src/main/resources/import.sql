...
insert into game (id,name,category,release_date,description,copertina,images) values (nextval('games_seq'),'Destiny','Adventure',2015,'"Destiny" è un gioco sparatutto in prima persona sviluppato da Bungie. Ambientato in un universo futuristico e condiviso online, i giocatori assumono il ruolo di Guardiani, protettori dell umanità dotati di poteri speciali.  ','/images/destinyCopertina.jpg' , ARRAY['/images/destiny/img1.jpg', '/images/destiny/img2.jpg', '/images/destiny/img3.jpg']);
